...
def update_all(i, line_data, line, bez1_data, bez1, path_data, path):
	#print path_data[..., i]
	i = i + 0.01
	t = i / frames
	...
	path_data[..., i] = [nx, ny]
	#print line_data[0, 0], line_data[0, 1], line_data[0, 2], 
	print line_data
...
both_ani = animation.FuncAnimation(fig1, update_all, frames, fargs=(line_data, l, bez1_data, b1, path_data, p), interval=10, blit=True)
